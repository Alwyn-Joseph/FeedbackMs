                    ...
                    <div class="row">
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:18rem;">
                                <img src="images/facultyfeed.png" class="card-img-top" alt="feedbacks">
                                <div class="card-body">
                                    <h5 class="card-title">Faculty Feedbacks</h5>
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="addfac.php" class="btn btn-primary">Add</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:18rem;">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Modify Faculties</h5>
