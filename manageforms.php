                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="facFeedMod.php" class="btn btn-primary">Modify</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="facilityMod.php" class="btn btn-primary">Modify</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="empFeedMod.php" class="btn btn-primary">Modify</i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                <img src="images/modfac.png" class="card-img-top" alt="add">
                                <div class="card-body">
                                    <h5 class="card-title">Parent Feedback Form</h5>
                                    <a href="parFeedMod.php" class="btn btn-primary">Modify</i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="alumniFeedForm.php" class="btn btn-primary">Modify</i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="eventFeedForm.php" class="btn btn-primary">Modify</i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="exFeedForm.php" class="btn btn-primary">Modify</i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-4">
                            <div class="card" style="width:15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="courseExitForm.php" class="btn btn-primary">Modify</i></a>
                                </div>
                            </div>
                        </div>
                    </div>
