                ...
                <script>
                    window.onload = function swal() {
                        Swal.fire({
                            icon: \'success\',
                    title: \'Registered\',
                    text: \'Faculty successfully registered!\',
                    })
                    };
                </script>';
            }
                        ...
                        <script>
                            window.onload = function swal() {
                                Swal.fire({
                                    icon: \'warning\',
                            title: \'Warning!\',
                            text: \'The Faculty ID should be in the form FNNN eg: F101\',
                            })
                            };
                        </script>';
        }
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="facultys.php">
...
<form action="" method="post" style="border:1px solid #ccc">
  <div class="container">
    ...
    <p class="text-center">Please fill in this form to add a faculty.</p>
    <hr>
    ...
    <div class="clearfix">
      ...
      <button name="insert" type="submit" class="signupbtn">Add faculty</button>
    </div>
  </div>
</form>
