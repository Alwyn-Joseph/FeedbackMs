                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        <h4><?php echo "$name"; ?></h4>
                                        <p class="text-muted font-size-sm">Course Id: <?php echo "$cid"; ?></p>
                                        <p class="text-muted font-size-sm">State: <?php echo "$state"; ?></p>
                                        <p class="text-muted font-size-sm">Nationality: <?php echo "$nation"; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
