...
if (isset($_SESSION['login_user_student'])) {
    ...
    $query2 = "select * from courses where c_id='$cId'";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "insert into course_exit(s_id,s_name,c_id,c_name,date,q1,q2,q3,q4,q5,q6,cmnts) values('$s_id','$sname','$cId','$c_name','$date','$q1','$q2','$q3','$q4','$q5','$q6','$cmnts')";
...
<body>
    <div class="mb-3" id="title">
        <center>
            <h1 class="display-4 text-white">Course Exit Form</h1>
    ...
    <form method="post" action="">
        <div class="mb-3">
            ...
            <br>
                <?php
                    $query4 = "select * from questions where f_id='FM110'";
