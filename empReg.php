...
<form action="" method="post" style="border:1px solid #ccc">
  <div class="container">
    <h1 class="text-center">Employer Registration</h1>
    <p class="text-center">Please fill in this form to add a employer.</p>
    <hr>
    ...
    <div class="clearfix">
      ...
      <button name="insert" type="submit" class="signupbtn">Add Employer</button>
    </div>
  </div>
</form>
