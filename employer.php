        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="employer.php">
                                <span data-feather="bar-chart-2"></span>
                                Employer
                            </a>
                        </li>
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <div class="row">
                        <?php
                            $empQuery = "select * from employer";
                            $empRes = mysqli_query($con, $empQuery);
                            while ($empRow = mysqli_fetch_array($empRes)) {
                                echo '<div class="col-sm-3 mb-4">
                                        <div class="card" style="width:15rem;">
                                        <div class="card-body text-center">
                                        <h5 class="card-title">' . $empRow['e_name'] . '</h5>
                                        <form action="sendmail.php" method="post">
                                            <button type="submit" name="e_id" value="' . $empRow['e_id'] . '"
                                        class="btn btn-outline-primary">Request Feedback</button>
                                        </form>
                                        </div>
                                        </div>
                                    </div>';
                ...
                <div
                    class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Employer Feedbacks</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-toolbar mb-2 mb-md-0">
                ...
                <table class="table table-striped" id="facFeedTable">
                    <tbody>
                        ...
                        <?php
                            include 'config.php';
                            $sql = "SELECT * FROM employer_feedback";
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <td>' . $row['q15'] . '</td>
                                <td>' . $row['q16'] . '</td>
                                <td>' . $row['cmnt1'] . '<br>' . $row['cmnt2'] . '<br>' . $row['cmnt3'] . '</td>
                                </tr>';
                            }
                            ?>
                    </tbody>
