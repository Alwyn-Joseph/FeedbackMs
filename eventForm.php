...
if (isset($_SESSION['login_user_student'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "insert into event_feedback(s_id,e_name,q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,q12,cmnt) values('$s_id','Workshop on PHP','$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$q9','$q10','$q11','$q12','$cmnts')";
