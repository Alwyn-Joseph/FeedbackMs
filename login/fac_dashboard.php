...
<body>
    <style>
        body {
   background-color: rgb(255, 255, 255); /*Default bg, similar to the background's base color*/
  ...
  <div class="wrapper">
    ...
    <nav id="sidebar">
      <div class="sidebar-header">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="active">
                <a href="fac_dashboard.php">Home</a>
                
            </li>
            <li>
                <a href="./IA_Management/ia_marks.php">IA Management</a>
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="downloadSubmenu">
                    <li>
                        <a href="./faculty_download/student_excel.php">Student</a>
                    </li>
                    <li>
                        <a href="#">IA Marks</a>
                    </li>
    ...
    <div id="content">
        ...
        <div>
            ...
            <h1>you have logged in as Faculty</h1>
