...
--
-- Table structure for table `eexaminer_feedback`
--

DROP TABLE IF EXISTS `eexaminer_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `eexaminer_feedback` (
...
--
-- Dumping data for table `eexaminer_feedback`
--

LOCK TABLES `eexaminer_feedback` WRITE;
/*!40000 ALTER TABLE `eexaminer_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `eexaminer_feedback` ENABLE KEYS */;
UNLOCK TABLES;
